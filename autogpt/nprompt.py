...
from autogpt.npromptgenerator import PromptGenerator
...
def get_prompt() -> str:
    ...
    prompt_generator.add_constraint("No user assistance after having all the information.")
    prompt_generator.add_constraint(
    ...
    prompt_generator.add_constraint(
        "Use the user location or zip code when searching on websites"
    )
    ...
    commands = [
        (
            ...
            "store_search",
            {"store_name": "<store_name>", "search_description": "<text_with_search_parameters>"},
        ),
        (
        ...
        ("Analyse Image", "analyse_image", {"image": "<image>"}),
    ]
